...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      do i = 2-mbc, mx+mbc, _SOLVER_CHUNK_SIZE
       ...
       call rpn2_vec(hL, hR, huL, huR, hvL, hvR, bL, bR, pL, pR, fw, sw)
...
!--        enddo
      ...
      ! receives "_SOLVER_CHUNK_SIZE" Riemann problems and solves them
      subroutine rpn2_vec(hL,hR, huL,huR, hvL,hvR, bL,bR, pL,pR, fw, sw)
